...
while running:
    ...
    if state == 'RUNNING':
        ...
        screen.blit(bunny_eeping, (screen_width / 2 - bunny_eeping.get_width() / 2, screen_height / 2 - bunny_eeping.get_height() / 2 + 110))
    elif state =='ABSENT_w':
        screen.blit(bunny_working, (screen_width / 2 - bunny_working.get_width() / 2, screen_height / 2 - bunny_working.get_height() / 2 + 110))
